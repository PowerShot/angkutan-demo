...
export default {
  ...
  home: { greetMorning: 'Good morning', greetDay: 'Good afternoon',
          ...
          docNear: 'Expires soonest', docOk: 'All documents in order',
          unpaid: '{n} unpaid', late: '{n} late',
          onTime: 'Nothing overdue', done: '{n} completed',
  ...
  common: { change: 'Change', maps: 'Maps', waze: 'Waze',
            navigate: 'Navigate', destination: 'Destination', back: 'Back', close: 'Close', all: 'All', search: 'Search',
